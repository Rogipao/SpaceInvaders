...
class Block(pygame.sprite.Sprite):
    ...
    def __init__(self, color = YELLOW, size = 10):
        """
...
class Ship(pygame.sprite.Sprite):
    ...
    def __init__(self, path, pos_x, pos_y, speed = 8):
        """
        Cria uma nave.
        ...
        self.__sound_shot = pygame.mixer.Sound(DIRECTORY + "/sounds/pu.mp3")
    ...
    def update(self, *args):
        ...
        # Se estiver pressionando o botão da seta da esquerda
            ...
            if self.rect.left > self.speed:
                self.rect.x -= self.speed
        # Se estiver pressionando o botão da seta para cima
        if pygame.key.get_pressed()[pygame.K_UP]:
           if self.rect.top > self.speed:
            self.rect.y -= self.speed
        # Se estiver pressionando o botão da seta para baixo
...
class Bullet(pygame.sprite.Sprite):
    ...
    def __init__(self, pos_xy, direction, color = SPRINGREEN, speed = 8):
        ...
        """
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load(DIRECTORY + "/images/missil2.png")

        # Redimensionar a imagem
        new_width = 10  # Defina a largura desejada
        new_height = 30 # Defina a altura desejada
        self.image = pygame.transform.scale(self.image, (new_width, new_height))

        self.rect = self.image.get_rect()
        self.rect.x = pos_xy[0]
        self.rect.y = pos_xy[1]  # Corrigido de pos_xy[0] para pos_xy[1]
...
class SpaceInvaders():
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("GUERRA FRIA II")
        ...
        self.path_image_ship = DIRECTORY + "/images/usa.webp"
        background_image = pygame.image.load(DIRECTORY + "/images/mundi.jpg")
    ...
    def home_screen(self):
        ...
        text = self.font.render("GUERRA FRIA II", True, GREEN)
    ...
    def create_invaders(self):
        ...
        for i in range(1, 8):
            enemy_types.append(pygame.image.load(DIRECTORY + ("/images/URSS.png")))
            enemy_types.append(pygame.image.load(DIRECTORY + ("/images/china.png")))
